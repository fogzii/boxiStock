          ...
          <div className="space-y-4">
            ...
            <div className="flex p-1 bg-background/50 border border-primary/20 rounded-lg">
              <button
                ...
                className={cn(
                  "flex-1 py-2 text-body-sm-strong rounded-md transition-all",
                  importType === "stock"
            ...
            >
              <textarea
                ...
                required
                className="w-full bg-background/50 border border-primary/20 rounded-md p-3 text-body-sm focus-visible:outline-none focus:ring-1 focus:ring-primary focus:border-primary resize-none placeholder:text-muted-foreground"
              />
            </FormField>
