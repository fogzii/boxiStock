      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6">
        <div className="space-y-5">
          ...
          <div className="space-y-2">
            <Label htmlFor="bundle-name" className="text-muted-foreground">
              Bundle Name
            </Label>
            <Input
              id="bundle-name"
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-center gap-2 min-w-0">
                              <span
                                className={`text-sm truncate ${!hasStock ? "text-muted-foreground/50" : "text-foreground"}`}
                              >
                                {product.name}
                              </span>
                            ...
                            <button
                              ...
                              className={`text-xs px-2.5 py-1 rounded-md font-medium transition-colors shrink-0 ml-2 ${
                                isAdded
                ...
                {searchTotalPages > 1 && (
                  <>
                    <button
                      ...
                      className="p-1 text-muted-foreground hover:text-foreground disabled:opacity-30 cursor-pointer disabled:cursor-default"
                    >
          ...
          {bundleItems.length > 0 && (
            <div className="space-y-2">
              <Label className="text-muted-foreground">Bundle Items</Label>
              <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <Input
                            ...
                            className="w-20 h-9 text-sm bg-background/50 border-primary/20"
                          />
                        ...
                        {item.fifo.breakdown.map((b) => (
                          ...
                          >
                            ...
                            <span>
                              ...
                              {b.qty !== 1 ? "s" : ""} @{" "}
                              {formatter.format(b.buyPrice)}
                              {b.fullyDepleted && (
                                <span className="ml-1.5 text-amber-500/80 font-medium">
                                  (depleted)
                                </span>
                              )}
                            </span>
                            <span className="ml-auto text-muted-foreground/60">
                              {formatter.format(round2(b.qty * b.buyPrice))}
                            </span>
                          </div>
                        ))}
                        {!item.fifo.hasEnough && (
            ...
            <div className="border border-primary/20 rounded-lg bg-background/50 divide-y divide-primary/10">
              ...
              <div className="flex items-center justify-between pl-4 pr-3 h-11 gap-4">
                ...
                >
                  <span
                    ...
                    aria-hidden
                    className="absolute invisible whitespace-nowrap text-sm pointer-events-none"
                  >
                    {sellPriceStr || "0.00"}
                  </span>
                  ...
                  <Input
                    ...
                    className="w-full pl-5 h-8 text-sm bg-background border-primary/20 text-right pr-2 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                    placeholder="0.00"
                    required
                  />
                </div>
              ...
              {bundleItems.length > 0 && sellPriceStr !== "" && (
                <div className="flex items-center justify-between pl-4 pr-5 h-9">
                  ...
                  <span className="text-xs text-muted-foreground/50">
                    {formatter.format(perProductProfit)} each
                  </span>
                </div>
              )}
            </div>
  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-2 h-9 px-4 text-sm font-medium text-primary hover:text-primary/80 bg-primary/10 hover:bg-primary/20 border border-primary/20 hover:border-primary/40 rounded-lg transition-all cursor-pointer whitespace-nowrap"
      >
