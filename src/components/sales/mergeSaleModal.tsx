        ...
        <div className="rounded-xl border border-border/40 overflow-hidden">
          ...
          <div
            className={`px-4 pt-4 pb-1 transition-colors ${
              selectedTarget ? "bg-primary/5" : "bg-white/[0.03]"
            }`}
          >
            {selectedTarget ? (
              <>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center justify-end gap-2">
            {isSearchOpen && (
              <div className="flex items-center gap-1 mr-auto">
                <input
                  ...
                  className="h-7 w-36 sm:w-48 rounded-lg bg-white/[0.06] border border-border/40 px-2.5 text-xs text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:border-primary/50 transition-colors"
                />
                <button
                  type="button"
                  onClick={() => {
            ...
            <button
              ...
              className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-muted-foreground hover:text-foreground hover:bg-primary/5 disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer transition-colors"
