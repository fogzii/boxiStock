      ...
      {isLoading ? (
        ...
        <div className="flex flex-col gap-5">
          <div className="flex flex-col gap-2">
            <Label className="text-muted-foreground">Your share link</Label>
            <div className="flex gap-2">
              <Input
                readOnly
                value={publicUrl}
                className="bg-background/50 border-primary/20 h-11 text-sm flex-1 cursor-text select-all"
              ...
              <Button
                ...
                variant="outline"
                onClick={handleCopy}
                className="h-11 px-3 border-primary/20 cursor-pointer shrink-0"
              >
                {copied ? (
          ...
          <div className="flex flex-col gap-1.5 text-sm text-muted-foreground bg-primary/5 border border-primary/10 rounded-xl p-4">
          ...
          {disableConfirm ? (
            <div className="flex flex-col gap-3">
              <p className="text-sm text-destructive/90 bg-destructive/10 border border-destructive/20 rounded-lg px-4 py-3">
              ...
              <div className="flex gap-3">
                ...
                <Button
                  ...
                  disabled={isDisabling}
                  className="flex-1 h-11 bg-destructive hover:bg-destructive/90 text-destructive-foreground font-bold cursor-pointer"
                >
            ...
            <Button
              ...
              className="w-full h-11 border-destructive/30 text-destructive hover:bg-destructive/10 hover:border-destructive/50 cursor-pointer"
            >
              Disable Link
            </Button>
          )}
        ...
        <div className="flex flex-col gap-6">
          {/* Section pills */}
          <div className="flex flex-col gap-2">
            <Label className="text-muted-foreground">Sections to share</Label>
              ...
              {SECTIONS.map(({ key, label }) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "px-3 py-1.5 rounded-md border text-sm font-medium transition-all cursor-pointer",
                      active
          ...
          <div className="flex flex-col gap-2">
            <button
              ...
              className={cn(
                "flex items-center gap-2 self-start px-3 py-1.5 rounded-md border text-sm font-medium transition-all cursor-pointer",
                showPasswordField
                  ? "bg-primary/20 border-primary/40 text-primary"
                  : "bg-background/50 border-primary/20 text-muted-foreground hover:border-primary/40 hover:text-foreground",
              )}
          ...
          {/* Expiry */}
          <div className="flex flex-col gap-2">
            <Label className="text-muted-foreground">Link expiry</Label>
            <div className="flex flex-wrap gap-2">
          ...
          <Button
            ...
            className="h-12 font-bold shadow-[0_0_20px_-5px_rgba(145,128,168,0.4)] hover:shadow-[0_10px_40px_-10px_rgba(145,128,168,0.6)] cursor-pointer"
          >
            {isCreating ? (
              <>Creating…</>
            ) : (
